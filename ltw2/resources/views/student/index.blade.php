	                ...
	                <div class="blocknews">
	                    ...
	                    <div class="media-body">
	                        ...
	                        <ul class="data-lessons">
	                            ...
	                            <li><a href="/ltw2/public/update/{!! $item->student_id !!}/edit" class="btn btn-warning">Update</a></li>
	                            <li><a href="/ltw2/public/forminsert" class="btn btn-success">Insert</a></li>
	                            <li><a href="/ltw2/public/delete/{!! $item->student_id !!}" class="btn btn-danger">Delete</a></li>
	                        </ul>
	                    </div>
	                </div>
	                @endforeach
